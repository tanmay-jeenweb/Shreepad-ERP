                    ...
                    <form onSubmit={handleCreateUser} className="space-y-6">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <input
                                ...
                                className="h-4 w-4 text-[#369ACF] border-slate-300 rounded focus:ring-[#369ACF]"
                            />
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-[#369ACF] hover:bg-[#2583b4] focus:ring-2 focus:ring-offset-2 focus:ring-[#369ACF] disabled:opacity-50 transition-colors"
                            >
