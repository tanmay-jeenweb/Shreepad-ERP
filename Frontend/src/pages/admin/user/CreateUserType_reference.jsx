...
const PERM_COLORS = {
  canRead:   { bg: "#f0f7fc", border: "#b4dffd", text: "#2991D6", check: "#2991D6" },
...
export default function CreateUserType() {
  ...
  const togglePerm = (masterKey, perm) => {
    ...
    if (isApprovalRow && (perm === "canUpdate" || perm === "canDelete")) return;
    setPermissions((prev) =>
      prev.map((p) =>
  ...
  const toggleColumn = (perm) => {
    const allChecked = permissions.every((p) => {
      ...
      if (isApprovalRow && (perm === "canUpdate" || perm === "canDelete")) return true;
      return p[perm];
    });
    setPermissions((prev) =>
      prev.map((p) => {
        ...
        <form onSubmit={handleAddType}>
          ...
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 14, padding: "24px", marginBottom: 20, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
            ...
            <input
              ...
              onFocus={e => e.target.style.borderColor = "#2991D6"}
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "1.5px solid #2991D6", color: isAllAll() ? "#fff" : "#2991D6",
                  background: isAllAll() ? "#2991D6" : "#eef6fc", transition: "all 0.2s"
                }}
              >
                      ...
                      >
                        <td style={{ padding: "12px 14px", fontSize: 14, fontWeight: 600, color: "#334155", borderBottom: "1px solid #f1f5f9" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#2991D6", flexShrink: 0 }} />
                            {master.label}
                          </div>
                        </td>
                        {PERMS.map((perm) => {
                        ...
                        <td style={{ textAlign: "center", padding: "12px 8px", borderBottom: "1px solid #f1f5f9" }}>
                          <button
                            ...
                            style={{
                              ...
                              border: `1.5px solid ${rowAll ? "#2991D6" : "#cbd5e1"}`,
                              color: rowAll ? "#fff" : "#64748b",
                              background: rowAll ? "#2991D6" : "#f8fafc",
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                background: saving ? "#94a3b8" : "linear-gradient(135deg,#2991D6,#1b7ec0)",
                color: "#fff", fontWeight: 700, fontSize: 14, cursor: saving ? "not-allowed" : "pointer",
                boxShadow: saving ? "none" : "0 2px 8px rgba(41, 145, 214,0.35)",
                transition: "all 0.2s"
              }}
            >
