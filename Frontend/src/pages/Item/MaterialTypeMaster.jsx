...
import { createMaterialType, getMaterialTypes, updateMaterialType, deleteMaterialType } from "../../api/materialTypeApi";
      ...
      { key: "id", label: "ID", minWidth: "60px" },
      {
        ...
        render: (row) =>
          editingId === row.id ? (
            ...
            <span className="font-semibold text-blue-900">{row.material_type_name}</span>
          ),
      },
    ];
    ...
    <div className="flex-1 flex flex-col bg-slate-50 font-sans text-slate-900">
      ...
      <main className="flex-1 flex flex-col w-full mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <DataTable
          ...
          actionButton={
            hasPermission("material_type", "write") ? (
              <button
            ...
            <div className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl animate-in zoom-in duration-200">
              <div className="mb-4 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500">Create a new material type master entry.</p>
                </div>
                <button
                  type="button"
