...
const mouldRoutes = require("./routes/mouldRoutes.js");
...
const jobPartyTypeRoutes = require("./routes/jobPartyTypeRoutes.js");
const jobPartyRoutes = require("./routes/jobPartyRoutes.js");
const operatorTypeRoutes = require("./routes/operatorTypeRoutes.js");
const operatorRoutes = require("./routes/operatorRoutes.js");
const reasonForDelayTypeRoutes = require("./routes/reasonForDelayTypeRoutes.js");
const reasonForDelayRoutes = require("./routes/reasonForDelayRoutes.js");
// const itemRoutes = require("./routes/itemRoutes.js");
const vendorRoutes = require("./routes/vendorRoutes.js");
const customerRoutes = require("./routes/customerRoutes.js");
const reasonRoutes = require("./routes/reasonRoutes.js");
const subSdReasonRoutes = require("./routes/subSdReasonRoutes.js");
...
const poApprovalRoutes = require("./routes/poApprovalRoutes.js");
...
const qcRoutes = require("./routes/qcRoutes.js");
...
const { createMouldsTable, ensureMouldColumns } = require("./models/mouldModel.js");
...
const { createRawMaterialsTable, ensureRawMaterialColumns } = require("./models/rawMaterialModel.js");
...
const { createJobPartyTypesTable } = require("./models/jobPartyTypeModel.js");
const { createJobPartiesTable } = require("./models/jobPartyModel.js");
...
const { createReasonForDelayTypesTable } = require("./models/reasonForDelayTypeModel.js");
const { createReasonsForDelayTable } = require("./models/reasonForDelayModel.js");
...
const { createReasonMasterTable } = require("./models/reasonModel.js");
const { createSubSdReasonMasterTable } = require("./models/subSdReasonModel.js");
const { createProcessMastersTable } = require("./models/processMasterModel.js");
const { createPurchaseOrderTables, ensurePurchaseOrderColumns, ensurePurchaseOrderItemsColumns } = require("./models/purchaseOrderModel.js");
const { createPoApprovalLogsTable } = require("./models/poApprovalModel.js");
const { createGrnTables, ensureGrnColumns, ensureGrnItemsColumns } = require("./models/grnModel.js");
// const { createGrnTables } = require("./models/grnModel.js");
...
const { createQcTables, ensureQcItemsColumns } = require("./models/qcModel.js");
...
app.use(["/api/moulds", "/moulds"], mouldRoutes);
...
app.use(["/api/raw-materials", "/raw-materials"], rawMaterialRoutes);
app.use(["/api/bom", "/bom"], bomRoutes);
app.use(["/api/terms-and-conditions", "/terms-and-conditions"], termsAndConditionsRoutes);
app.use(["/api/job-party-types", "/job-party-types"], jobPartyTypeRoutes);
app.use(["/api/job-parties", "/job-parties"], jobPartyRoutes);
app.use(["/api/operator-types", "/operator-types"], operatorTypeRoutes);
app.use(["/api/operators", "/operators"], operatorRoutes);
app.use(["/api/reason-for-delay-types", "/reason-for-delay-types"], reasonForDelayTypeRoutes);
app.use(["/api/reasons-for-delay", "/reasons-for-delay"], reasonForDelayRoutes);
// app.use(["/api/items", "/items"], itemRoutes);
app.use(["/api/vendors", "/vendors"], vendorRoutes);
app.use(["/api/customers", "/customers"], customerRoutes);
app.use(["/api/reasons", "/reasons"], reasonRoutes);
app.use(["/api/sub-sd-reasons", "/sub-sd-reasons"], subSdReasonRoutes);
...
app.use(["/api/po-approvals", "/po-approvals"], poApprovalRoutes);
app.use(["/api/so-approvals", "/so-approvals"], soApprovalRoutes);
app.use(["/api/grns", "/grns"], grnRoutes);
...
const startServer = async () => {
    try {
        ...
        await createMouldsTable();
        await ensureMouldColumns();
        ...
        await createRawMaterialsTable();
        await ensureRawMaterialColumns();
        await createBOMTable();
        await ensureBOMColumns();
        await createTermsAndConditionsTable();
        await createJobPartyTypesTable();
        await createJobPartiesTable();
        await createOperatorTypesTable();
        await createOperatorsTable();
        await ensureOperatorColumns();
        await createReasonForDelayTypesTable();
        await createReasonsForDelayTable();
        ...
        await createReasonMasterTable();
        await createSubSdReasonMasterTable();
        ...
        await createPoApprovalLogsTable();
        await createGrnTables();
        await ensureGrnColumns();
        await ensureGrnItemsColumns();
        ...
        await createQcTables();
        await ensureQcItemsColumns();
